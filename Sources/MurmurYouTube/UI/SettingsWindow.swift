        ...
        ZStack {
            ...
            VStack(alignment: .leading, spacing: DS.Space.wide) {
                panel(label: "Push to talk") {
                        ...
                        HStack(spacing: DS.Space.snug) {
                            ForEach(PushToTalkShortcut.presets, id: \.self) { preset in
                                TransportKey(
                                    ...
                                    isEngaged: settings.pushToTalkShortcut == preset,
                                ...
                                .background {
                                    if settings.pushToTalkShortcut == preset {
                    ...
                    note("Hold this key anywhere to dictate. Single modifiers (Right ⌥, fn) or combinations "
                        + "(⌥ Space, ⌃ Space, custom) hold the mic open until released.")
                }
